...
public class Main extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    private DrawerItem createItemFor(int position) {
        return new SimpleItem(screenIcons[position], screenTittles[position])
                .withIconTint(color(R.color.light_gray))
                .withTextTint(color(R.color.black))
                .withSelectedIconTint(color(R.color.light_gray))
                .withSelectedTextTint(color(R.color.light_gray));
    }
